                ...
                Object.entries(changesByFile).forEach(([fileName, fileChanges]) => {
                    ...
                    traverse(ast, {
                        JSXOpeningElement: (path) => {
                            const lineNumber = (path.node.loc && path.node.loc.start) ? path.node.loc.start.line : null;
                            ...
                            changesAtLine.forEach((change) => {
                                ...
                                if (
                                    ...
                                    const oldClassName = (classAttr && classAttr.value && classAttr.value.value) ? classAttr.value.value : "";

                                    if (classAttr) {
                                        // Update existing className
                                        console.log(
                                            `[backend] Updating existing className from:`,
                                            (classAttr.value && classAttr.value.value) ? classAttr.value.value : "",
                                            "to:",
                                            change.className,
                                        );
